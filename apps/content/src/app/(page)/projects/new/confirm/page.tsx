...
import { calculateProjectProfit, formatMoney, formatRate } from ':/app/(page)/projects/_utils/project-profit'
...
export default async function ConfirmCreatePage() {
  ...
  const parsed = apiProjectFormSchema.safeParse(rawFormData)
    ...
    <>
      ...
      <div className="title-nav">
        ...
        <div className="button-nav">
          <Link href="/projects/new?from=confirm" className="btn btn-lg btn-light">
            入力へ戻る
          </Link>
