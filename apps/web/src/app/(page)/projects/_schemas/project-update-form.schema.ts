/**
 * プロジェクト更新フォームの Zod スキーマ。
 *
 * @see _references/nablarch-example-web/src/main/java/com/nablarch/example/app/web/form/ProjectUpdateForm.java
 */
import { z } from "zod";
...
export type ProjectUpdateForm = z.infer<typeof projectUpdateFormSchema>;
