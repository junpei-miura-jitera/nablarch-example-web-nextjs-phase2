import type { ProjectProfit } from "./project-constants";

/**
 * プロジェクトの収益指標を計算する。
 *
 * 売上高・原価・販管費・本社配賦から、粗利・配賦前利益・営業利益とその利益率を算出する。
 * 利益率の丸めは Java の RoundingMode.DOWN（ゼロ方向切捨て）に合わせて Math.trunc を使用する。
 *
