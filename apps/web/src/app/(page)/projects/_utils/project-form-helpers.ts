import type { ProjectForm as ProjectFormValues } from "../_schemas/project-form.schema";
 ...
 */
export function transformProjectFormData(data: ProjectFormValues) {
  return {
    ...data,
    ...
    allocationOfCorpExpenses: data.allocationOfCorpExpenses ? Number(data.allocationOfCorpExpenses) : null,
  };
}
