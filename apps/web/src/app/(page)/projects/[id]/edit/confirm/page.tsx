...
import { projectUpdateFormSchema } from "../../../_schemas/project-update-form.schema";
...
export default async function ConfirmUpdatePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const parsed = projectUpdateFormSchema.safeParse(rawFormData);
    ...
    <ProjectSidemenuLayout>
      <div className="title-nav">
        ...
        <div className="button-nav">
          <Link href={`/projects/${projectId}/edit`} className="btn btn-lg btn-light">入力へ戻る</Link>
