...
// src/main/webapp/WEB-INF/view/project/confirmOfUpdate.jsp
export function SrcMainWebappWEBINFViewProjectConfirmOfUpdateCandidatePage() {
  ...
  return (
    <section>
      <h2>SrcMainWebappWEBINFViewProjectConfirmOfUpdateCandidatePage</h2>
      <p>Source JSP: <code>src/main/webapp/WEB-INF/view/project/confirmOfUpdate.jsp</code></p>
