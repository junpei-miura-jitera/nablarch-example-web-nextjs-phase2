...
export function SrcMainWebappWEBINFViewLoginIndexCandidatePage() {
  ...
  return (
    <section>
      <h2>SrcMainWebappWEBINFViewLoginIndexCandidatePage</h2>
      <p>Source JSP: <code>src/main/webapp/WEB-INF/view/login/index.jsp</code></p>
