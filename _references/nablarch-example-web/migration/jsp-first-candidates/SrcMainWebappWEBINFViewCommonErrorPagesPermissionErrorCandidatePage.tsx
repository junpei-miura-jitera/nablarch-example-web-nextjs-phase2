...
// src/main/webapp/WEB-INF/view/common/errorPages/permissionError.jsp
export function SrcMainWebappWEBINFViewCommonErrorPagesPermissionErrorCandidatePage() {
  ...
  return (
    <section>
      <h2>SrcMainWebappWEBINFViewCommonErrorPagesPermissionErrorCandidatePage</h2>
      <p>Source JSP: <code>src/main/webapp/WEB-INF/view/common/errorPages/permissionError.jsp</code></p>
