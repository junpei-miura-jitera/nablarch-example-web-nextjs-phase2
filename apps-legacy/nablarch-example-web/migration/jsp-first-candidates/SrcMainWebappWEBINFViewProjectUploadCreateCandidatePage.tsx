...
export function SrcMainWebappWEBINFViewProjectUploadCreateCandidatePage() {
  ...
  return (
    <section>
      <h2>SrcMainWebappWEBINFViewProjectUploadCreateCandidatePage</h2>
      <p>Source JSP: <code>src/main/webapp/WEB-INF/view/projectUpload/create.jsp</code></p>
...
// - c:if at line 23: <c:if test="${not empty uploadProjectSize}">
