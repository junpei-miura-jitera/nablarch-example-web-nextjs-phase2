...
export function SrcMainWebappWEBINFViewCommonFooterCandidatePage() {
  ...
  return (
    <section>
      <h2>SrcMainWebappWEBINFViewCommonFooterCandidatePage</h2>
      <p>Source JSP: <code>src/main/webapp/WEB-INF/view/common/footer.jsp</code></p>
