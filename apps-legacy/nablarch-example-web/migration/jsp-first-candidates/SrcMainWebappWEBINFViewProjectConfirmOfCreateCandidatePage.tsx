...
// src/main/webapp/WEB-INF/view/project/confirmOfCreate.jsp
export function SrcMainWebappWEBINFViewProjectConfirmOfCreateCandidatePage() {
  ...
  return (
    <section>
      <h2>SrcMainWebappWEBINFViewProjectConfirmOfCreateCandidatePage</h2>
      <p>Source JSP: <code>src/main/webapp/WEB-INF/view/project/confirmOfCreate.jsp</code></p>
