...
// src/main/webapp/WEB-INF/view/common/errorPages/userError.jsp
export function SrcMainWebappWEBINFViewCommonErrorPagesUserErrorCandidatePage() {
  ...
  return (
    <section>
      <h2>SrcMainWebappWEBINFViewCommonErrorPagesUserErrorCandidatePage</h2>
      <p>Source JSP: <code>src/main/webapp/WEB-INF/view/common/errorPages/userError.jsp</code></p>
