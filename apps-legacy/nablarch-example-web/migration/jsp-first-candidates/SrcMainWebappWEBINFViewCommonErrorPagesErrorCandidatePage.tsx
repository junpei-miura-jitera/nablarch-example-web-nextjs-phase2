...
// src/main/webapp/WEB-INF/view/common/errorPages/error.jsp
export function SrcMainWebappWEBINFViewCommonErrorPagesErrorCandidatePage() {
  ...
  return (
    <section>
      <h2>SrcMainWebappWEBINFViewCommonErrorPagesErrorCandidatePage</h2>
      <p>Source JSP: <code>src/main/webapp/WEB-INF/view/common/errorPages/error.jsp</code></p>
