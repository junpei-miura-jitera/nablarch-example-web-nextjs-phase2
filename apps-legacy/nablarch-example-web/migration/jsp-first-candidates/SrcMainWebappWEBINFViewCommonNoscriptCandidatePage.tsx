...
// src/main/webapp/WEB-INF/view/common/noscript.jsp
export function SrcMainWebappWEBINFViewCommonNoscriptCandidatePage() {
  ...
  return (
    <section>
      <h2>SrcMainWebappWEBINFViewCommonNoscriptCandidatePage</h2>
      <p>Source JSP: <code>src/main/webapp/WEB-INF/view/common/noscript.jsp</code></p>
